...
from llm_perf.backends.NPU.npu_mp_engine import NpuMpEngine
from llm_perf.utils.logger import logger

class NpuInferencer(CoreInferencer):
    def __init__(self, model_impl, xpu_cfg):
        ...
        self.mp_engine = NpuMpEngine(self.tp_size, model_impl, xpu_cfg)    
