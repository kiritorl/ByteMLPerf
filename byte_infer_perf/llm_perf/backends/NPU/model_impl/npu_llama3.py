...
from llm_perf.utils.dist_utils import check_dist_npu
...
class NPULlamaLoader(NpuCkptLoader):
    def __init__(
        self, 
...
class NPULlama(nn.Module):
    ...
    def load_weight(self, ckpt_path):
        p_loader = NPULlamaLoader(self.transformer_model, self.llama_config, ckpt_path)
